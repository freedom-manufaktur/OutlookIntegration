OutlookIntegration 📧
===
Contains documentation and setup scripts for the **OutlookIntegration** microservice used as basis for the **[Outlook Dispatcher](https://freedom-manufaktur.com/outlook-dispatcher/)**.
